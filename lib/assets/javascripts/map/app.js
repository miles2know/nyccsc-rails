...
$("#sidebarmap-btn").click(function() {
  $("#sidebarmap").toggle();
  map.invalidateSize();
  return false;
});

$("#sidebarmap-hide-btn").click(function() {
  $('#sidebarmap').hide();
  map.invalidateSize();
});


function sidebarmapClick(id) {
  /* Hide sidebarmap and go to the map on small screens */
...
//loads the information to construct the sidebarmap TOC
...
/* Larger screens get expanded layer control and visible sidebarmap */
if (document.body.clientWidth <= 767) {
