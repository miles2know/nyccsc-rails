    ...
    onEachFeature: function (feature, layer) {
        ...
        if (feature.properties) {
           ...
           var content =   "<table class='table table-striped table-bordered table-condensed'>"+
                                "<tr><th>County</th><td>" + feature.properties.countyname + "</td></tr>"+
                                "<tr><th>County GNIS</th><td>" + feature.properties.county_gnis + "</td></tr>"+
                                "<tr><th>DEC</th><td>" + feature.properties.dec_region + "</td></tr>"+
                            "<table>";
            if (document.body.clientWidth <= 767) {
                layer.on({
                    click: function(e) {
                        $("#feature-title").html(feature.properties.countyname);
