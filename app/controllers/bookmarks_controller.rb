...
class BookmarksController < CatalogController
  ...
  def create
    if params[:bookmarks]
      ...
      @bookmarks = [{ document_id: params["DocId"], document_type: blacklight_config.solr_document_model.to_s }]
    end
  ...
  def destroy
    bookmark = current_or_guest_user.bookmarks.where(document_id: params["DocId"], document_type: blacklight_config.solr_document_model).first
